...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Panel de administracion CSA",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Administracion CSA",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Administracion CSA",
...
LOGIN_REDIRECT_URL = "/perfil/"  # Ruta definida en home/urls.py
LOGOUT_REDIRECT_URL = "perfil"  # Ruta definida en home/urls.py
